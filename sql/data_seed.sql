...
('REGIONS', '00,07,11,13,14,21', 'Comma-separated list of regions to fetch gold prices for, e.g., 00 for HCM, 07 for Can Tho, 11 for Ha Noi, 
13 for Da Nang, 14 for Tay Nguyen, 21 for Dong Nam Bo'),
('LAST_SOURCE_UPDATE_TIME', '', 'Timestamp of the last successful data fetch from the source API');
